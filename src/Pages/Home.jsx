      ...
      <div className='home_container_center1'>
        <div className="home_center1">
          ...
          <Marquee gradient gradientColor='#f3f4f5' gradientWidth={100} className='marquee' pauseOnHover>
            ...
            <div className='image_wrapper'><img src={logo2} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo3} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo4} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo5} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            {/* <div className='image_wrapper'><img src={logo6} className='slider_img' /></div>
            <img src={logo_dots} className='slider_img1' /> */}

            <div className='image_wrapper'><img src={logo7} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo8} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo9} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo10} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo11} className='slider_img' alt="logo"/></div>
            <img src={logo_dots} className='slider_img1' alt="logo"/>

            <div className='image_wrapper'><img src={logo12} className='slider_img' alt="logo"/></div>
          </Marquee>
        </div>
      </div>
